...
global.botname = "「𝐂𝐋𝐎𝐖𝐍」" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "𝙋𝙄𝙆𝘼"  
global.packname = "「𝐂𝐋𝐎𝐖𝐍」"  
global.myweb = "https://github.com/PikaBotz" // You can put any link 
global.waterMark = "「𝐂𝐋𝐎𝐖𝐍」 ✓" // Your own watermark 
global.headerText = "Anya by Pika" // text for header of menu         
global.DocumentTitle = "MASTER⚔️PIKA" 


global.ownername = "「𝐂𝐋𝐎𝐖𝐍」"   // Owner name //        
global.ownernumber = ['447558815407'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : ZAYIEDXTRAVA" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT:CLOWN"   // Yt chanel name //
...
global.instagramId = "https://instagram.com/zayiedxtrava?igshid=NDk5N2NlZjQ=" // Your insta ID
global.email = "CLOWNXD99@gmail.com" // put your email here
...
nikalmsg1 = 'OOMBI, ERANGI PODA MIERE 😲🏻'  
nikalmsg2 = 'OOMBI FEK U MONA😂.'

//--------Random Tagall msg--------\\
tag1 = '𝘏𝘦𝘺 MEKKELE😚, KEMON FEN EDKK.' 
tag2 = '𝘖𝘺𝘦 𝘦𝘷𝘦𝘳𝘺𝘰𝘯𝘦!! 𝘞𝘩𝘦𝘳𝘦 𝘢𝘳𝘦 𝘺𝘰𝘶 𝘢𝘭𝘭?😐' 
tag3 = 'MEKKELEY ONLINE KEM FEN AVAAM!😑' 
tag4 = '𝘞𝘰𝘸 𝘭𝘰𝘰𝘬 𝘢𝘵 𝘵𝘩𝘪𝘴 𝘢𝘥𝘷𝘢𝘯𝘤𝘦 𝘉𝘰𝘵.😚' 
tag5 = 'ANTHADA FEYER AYA❤️' 
...
//--------------- Menu images ----------------\\
global.Menuimage = fs.readFileSync("./https://i.imgur.com/D0QNBtd.jpeg")
global.thumnnaiIs = fs.readFileSync("./https://i.imgur.com/D0QNBtd.jpeg")
